...
public class ExportFile {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Export " + fileNum + " files successfully (*^▽^*)");
    }
    ...
    private static void exportFile(File file) {
        ...
        for (File srcFile : fileList) {
            ...
            parentFolderName = parentFolderName.replace("E:\\classes", "");//parentFolderName.split("E:\\\\classes\\\\"+projectName + "\\\\");
            // 取出文件的父路径，添加到目标目录地址下
